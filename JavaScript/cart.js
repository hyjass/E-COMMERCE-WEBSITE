...
function displayInCartPage(total){
    ...
    subTotal.innerHTML = `Rs ${total.toFixed(2)}`;
    let totalOrder= parseFloat(subTotal.innerHTML.replace('Rs ', '')) + 70;
    document.getElementById("total_order").innerHTML = `Rs ${totalOrder.toFixed(2)}`;
}
function checkOut(){
